...
from models import db, User, ShoppingItem, Task, Reward, ClaimedReward, CoinTransaction, TaskTemplate
...
@login_required
def facturas():
    return "<h2>Gestión de facturas (en construcción)</h2>"

@app.route("/notas")
@login_required
def notas():
    return "<h2>Notas familiares (en construcción)</h2>"
